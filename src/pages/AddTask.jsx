...
export default function AddTask() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-purple-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-xl w-full mx-auto bg-white rounded-xl shadow-xl overflow-hidden transform transition-all hover:shadow-2xl">
            ...
            <div className="col-span-2 mt-4">
              ...
              <div className="space-y-2 mb-4">
                {subtasks.map((subtask, index) => (
                  ...
                  >
                    <span className="flex-grow min-w-0 px-3 py-2 bg-gray-50 rounded-l-md border border-r-0 border-gray-300 break-words">
                      {subtask.title}
                    </span>
                    <button
                      type="button"
